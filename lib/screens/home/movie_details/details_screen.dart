...
class DetailsScreen extends StatelessWidget {
  ...
  DetailsScreen(this.movieResult, {this.index});
                      ...
                      children: [
                        ...
                        StreamBuilder(
                          ...
                          builder: (context, snapshot) {
                            ...
                            var moviesResult = snapshot.data?.docs
                                    .map((doc) => doc.data())
                                    .toList() ??
                                [];
                            if (moviesResult.isEmpty) {
                              return BookmarkWidget(movieResult!, false);
                            }
                            ...
                            return BookmarkWidget(movieResult!, isSelected);
                          },
                        ),
                      ],
                    ),
